  ...
  function ContentMetadata({ cfg, fileData, displayClass }: QuartzComponentProps) {
    ...
    if (text) {
      ...
      if (fileData.frontmatter?.author) {
        const authorStr = Array.isArray(fileData.frontmatter.author)
          ? fileData.frontmatter.author.join (", ")
          : String(fileData.frontmatter.author);
        segments.push(<span class="author">autor: {authorStr}</span>);
      }
