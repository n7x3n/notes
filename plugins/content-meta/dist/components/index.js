  ...
  function ContentMetadata({ cfg, fileData, displayClass }) {
    ...
    if (text) {
      ...
      if (fileData.frontmatter?.author) {
        const authorStr = Array.isArray(fileData.frontmatter.author) ? fileData.frontmatter.author.join(", ") : String(fileData.frontmatter.author);
        segments.push(/* @__PURE__ */ u2("span", { class: "author", children: [
          "autor: ",
          authorStr
        ] }));
      }
